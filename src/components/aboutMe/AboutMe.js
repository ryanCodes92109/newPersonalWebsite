  ...
  return (
    ...
    <br/>
        <div className='aboutMeInfo'>
          ...
          <p>
            Feel free to <strong>contact</strong> me if I may be a good fit for any open positions you know of! In the meantime, here are a bunch of pictures of my amazing furry friends.
          </p> 
